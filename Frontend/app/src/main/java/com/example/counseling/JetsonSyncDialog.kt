...
@Composable
fun JetsonSyncDialog(onDismiss: () -> Unit) {
            ...
            LazyColumn(
                ...
                item {
                    Text(
                        "사진·음성 파일, 통화번호, 앱 사용 이벤트, 대화 원문은 보내지 않습니다. " +
                            "기기 안에서 만든 건강·생활 패턴·Gallery 요약과 최근 음성 감정 결과만 전송합니다. " +
                            "설정을 저장한 뒤에는 상담 중 자동 누적되고, 아래 버튼으로 지금 즉시 전송할 수도 있습니다.",
                ...
                item {
                    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        Text(
                            "iot.local이 해석되지 않으면 개발자 빌드에서 Jetson 사설 IP(예: http://192.168.0.22:8765)를 입력하세요. " +
